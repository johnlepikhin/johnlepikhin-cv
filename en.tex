...
\title{Team lead, software architect, developer, DevOps}
...
\cventry{2017--present}{Team lead}{VK (ex. Mail.Ru)}{Organization of a dev environment for developers and backend testing automation}{}{}
...
\cvline{Linux}{10+ years of experience in IT, thousands of hosts, participation in tasks from auto-deployment to writing kernel patches and building large scale systems.}
...
\cvline{Current stack}{Linux, Rust, Puppet}
\cvline{In the past}{C, C++, Java, Perl, Ocaml, Haskell, Elisp, Python, FreeBSD, Opensolaris}
