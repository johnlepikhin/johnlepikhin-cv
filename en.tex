...
A highly experienced and skilled Tech Lead, Software Architect, Developer, and DevOps professional with 10+ years of experience in Linux
SRE, backend architecture planning, and product development management. Seeking a challenging role in a dynamic organization.
...
\cventry{2017--present}{Infrastructure automation team lead}{VK (ex. Mail.Ru)}{Design, development and implementation of dev environment for
  400 engineers. Includes a new infrastructure for parallel builds and tests on a clusters of machines, workflow system for scheduling and
  robust execution.}{}{}
...
\cvline{Languages}{English: upper intermediate (B2), Russian: native}
